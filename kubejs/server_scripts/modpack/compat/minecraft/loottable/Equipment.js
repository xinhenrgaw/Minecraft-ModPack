...
LootJS.modifiers(event => {
  event
    ...
    // 皮革头盔 -> 旅行者护目镜
    .modifyLoot(Ingredient.of("minecraft:leather_helmet"), itemStack => {
      return Item.of('tconstruct:travelers_helmet', '{Damage:0,tic_broken:0b,tic_modifiers:[{level:1,name:"tconstruct:tanned"}],tic_persistent:{},tic_stats:{"tconstruct:armor":1.0f,"tconstruct:durability":110.0f},tic_volatile_data:{abilities:1,defense:2,upgrades:3}}');
    })
    // 皮革胸甲 -> 旅行者胸甲
    .modifyLoot(Ingredient.of("minecraft:leather_chestplate"), itemStack => {
      return Item.of('tconstruct:travelers_chestplate', '{Damage:0,tic_broken:0b,tic_modifiers:[{level:1,name:"tconstruct:tanned"}],tic_multipliers:{"tconstruct:attack_damage":0.55f},tic_persistent:{},tic_stats:{"tconstruct:armor":5.0f,"tconstruct:durability":160.0f},tic_volatile_data:{abilities:1,defense:2,upgrades:3}}');
    })
    // 皮革护腿 -> 旅行者护腿 
    .modifyLoot(Ingredient.of("minecraft:leather_leggings"), itemStack => {
    ...
    // 皮革护靴 -> 旅行者护靴
    .modifyLoot(Ingredient.of("minecraft:leather_boots"), itemStack => {
    ...
    .modifyLoot(Ingredient.of("minecraft:iron_leggings"), itemStack => {
      return Item.of('tconstruct:travelers_leggings', '{Damage:0,tic_broken:0b,tic_modifiers:[{level:1,name:"tconstruct:tanned"}],tic_persistent:{},tic_stats:{"tconstruct:armor":4.0f,"tconstruct:durability":150.0f},tic_volatile_data:{abilities:1,defense:2,upgrades:3}}');
    })
    // 铁护靴 -> 镶板铁护靴
    .modifyLoot(Ingredient.of("minecraft:iron_boots"), itemStack => {
      return Item.of('tconstruct:travelers_boots', '{Damage:0,tic_broken:0b,tic_modifiers:[{level:1,name:"tconstruct:tanned"},{level:1,name:"tconstruct:snow_boots"}],tic_persistent:{},tic_stats:{"tconstruct:armor":1.0f,"tconstruct:durability":130.0f},tic_volatile_data:{abilities:1,defense:2,"tconstruct:snow_boots":1b,upgrades:3}}');
    })
    // 金头盔 -> 镶板铁头盔
